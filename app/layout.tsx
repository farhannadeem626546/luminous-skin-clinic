...
export const metadata: Metadata = {
  ...
  icons: { icon: "/luminous-logo-transparent.png", apple: "/luminous-logo-transparent.png" }
};

export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const cms=await getCms(); const logoUrl=cms["global.logo_url"]||"/luminous-logo-transparent.png";
