...
import { concerns, reviews, treatments } from "@/data/site";
...
export default function Home() {
  ...
  return <>
    <section className="home-hero">
      ...
      <div className="container hero-content"><span className="eyebrow light">Personalised skin & wellness · Leeds</span><h1>Your Skin.<br/>Your Confidence.<br/><em>Your Glow.</em></h1><p>Professional, personalised treatments in a calm one-to-one setting — created around your skin goals, comfort and confidence.</p><div className="hero-actions"><Link href="/booking" className="button light-button">Book Appointment</Link><Link href="/skin-concerns" className="button ghost-light">Find My Treatment</Link></div><div className="hero-proof"><span>★★★★★</span><small>Trusted client experience · Accessible care</small></div></div>
    </section>
